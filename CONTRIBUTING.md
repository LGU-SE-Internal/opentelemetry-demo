...
We have the following policies for AI-assisted work to ensure quality and compliance:

- **No AI-generated comments on issues or PRs**: All comments and discussions on issue threads and pull requests must be written by human contributors.
- **No AI-generated PR descriptions**: Pull request descriptions must be written by the human submitting the PR, to accurately reflect the change and its context.
- **Disclose significant AI assistance in commits**: If a significant portion of your contribution was generated by AI tools, disclose this by adding an `Assisted-by:` trailer to your commit message (e.g. `Assisted-by: Claude Sonnet 4.6`). Do NOT use `Co-authored-by:` for AI assistance, as this will cause CLA check failures.
