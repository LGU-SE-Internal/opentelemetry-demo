...
// Stubs for types from spec (will be provided by implementation)
...
func NewRetryableDB(db *MockDBPool, cfg RetryConfig, metrics RetryMetrics) *RetryableDB {
	return &RetryableDB{db: db, config: cfg, metrics: metrics}
}
