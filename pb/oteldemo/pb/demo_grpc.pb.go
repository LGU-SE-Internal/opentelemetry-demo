...
func (UnimplementedProductReviewServiceServer) GetAverageProductReviewScore(context.Context, *GetAverageProductReviewScoreRequest) (*GetAverageProductReviewScoreResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetAverageProductReviewScore not implemented")
}
func (UnimplementedProductReviewServiceServer) AskProductAIAssistant(context.Context, *AskProductAIAssistantRequest) (*AskProductAIAssistantResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AskProductAIAssistant not implemented")
}
...
func RegisterProductReviewServiceServer(s grpc.ServiceRegistrar, srv ProductReviewServiceServer) {
	// If the following call panics, it indicates UnimplementedProductReviewServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
